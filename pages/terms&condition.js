            ...
            <div className='contact-div'>
                ...
                <div className='refund'>
                    ...
                    <ol>
                        ...
                        <li>
                            Internet delays. The Website may be subject to limitations, delays, and other problems inherent in the use of the Internet and electronic communications. We are not responsible for any delays, delivery failures, or other damages resulting from such problems.
                        </li>
                        <li>
                            Intellectual property rights. The Website and its entire contents, features, and functionality (including, but not limited to, all information, software, text, displays, images, video, and audio, and their design, selection, and arrangement) are owned by us, our licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.<br></br>
                        ...
                        <li>
                            Copyright infringement. If you believe that any content on the Website violates your copyright, please send a notice by email to Support@buraaqmart.com. Be advised that claimants who make misrepresentations about copyright infringement may be liable for damages, including court costs and attorneys’ fees.
                        </li>
                        <li>
                            Prohibited uses. You may use the Website only for lawful purposes in accordance with these Terms of Use. You agree not to use the Website:
                            <ul>
                                <li>
                        ...
                        <li>
                            Information about you and your visits to the Website. We may collect (or you may provide) your personally identifiable information. All information we collect on the Website is subject to our Privacy Policy. By using the Website, you consent to all actions taken by us with respect to your information in compliance with the Privacy Policy.
                        </li>
                        <li>
                            Linking to the Website. You may link to the Website, provided you do so in a way that is fair, legal and does not damage our reputation or take advantage of it, but you must not establish a link in such a way as to suggest any form of association, approval, or endorsement on our part.
                        </li>
                    </ol>
